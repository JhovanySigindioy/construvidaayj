// src/components/NewUsersTable.tsx
...
export default function NewUsersTable({ queryParams, officeSelected, dateSelected }: NewUsersTableProps) {
    // El hook useDailyNewAffiliations ahora recibe directamente los queryParams
    const {
        data: newUsersList,
        loading,
        error,
        refetch,
    } = useDailyNewAffiliations(queryParams);
    ...
    }, [queryParams, officeSelected, dateSelected, refetch]); // Añadimos refetch a las dependencias por buenas prácticas de useEffect
    ...
    return (
        ...
        <div className="bg-green-500 bg-opacity-20 border-4 border-green-500 rounded-lg shadow-md "> {/* Contenedor para la tabla interna */}
